/**
 * @file src/models/aptitude-attempt.model.ts
 * @category Mongoose DB Schema Model
 *
 * Why this code exists:
 * Defines the database schema structure, validation constraints, and indexing rules for the "aptitude-attempt" collection.
